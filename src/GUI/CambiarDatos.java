...
public class CambiarDatos extends JDialog {
	...
	public CambiarDatos(MenuTienda parent, Tienda tiendaPC) {
		...
		label_9.setFont(new Font("MS Reference Sans Serif", Font.PLAIN, 20));
		...
		label_10.setFont(new Font("MS Reference Sans Serif", Font.PLAIN, 20));
		...
		label_11.setFont(new Font("MS Reference Sans Serif", Font.PLAIN, 20));
		...
		label.setFont(new Font("MS Reference Sans Serif", Font.BOLD, 25));
		label.setBounds(56, 23, 548, 30);
		...
		label_3.setFont(new Font("MS Reference Sans Serif", Font.BOLD, 20));
		label_3.setBounds(226, 280, 213, 30);
		...
		label_6.setFont(new Font("MS Reference Sans Serif", Font.PLAIN, 20));
		...
		button.setBounds(441, 471, 219, 44);
		...
		button_2.setBounds(450, 476, 210, 39);
