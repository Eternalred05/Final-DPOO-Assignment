...
public class reporteTrabajador extends JDialog {
	...
	public reporteTrabajador(Tienda tiendaPC) {
		setResizable(false);
		...
		comboBoxCargo.setModel(new DefaultComboBoxModel(new String[] {"", "Gestor de Venta", "Encargado de inventario", "Asesor de ventas", "Especialista en productos", "Encargado de servicio", "Especialista en software", "Cajero"}));
		...
		label.setFont(new Font("Arial Black", Font.PLAIN, 23));
		label.setBounds(455, 32, 105, 34);
		contentPanel.add(label);

		JLabel label_1 = new JLabel("Cargo");
		label_1.setFont(new Font("Arial Black", Font.PLAIN, 23));
		label_1.setBounds(45, 32, 87, 34);
		contentPanel.add(label_1);

		JLabel label_2 = new JLabel("Nivel \r\nEscolar");
		label_2.setFont(new Font("Arial Black", Font.PLAIN, 23));
		label_2.setBounds(239, 32, 184, 34);
		contentPanel.add(label_2);

		final JSpinner spinnerSalario = new JSpinner();
		spinnerSalario.setFont(new Font("Arial Black", Font.PLAIN, 11));
		...
		btnFiltrar.setFont(new Font("Arial Black", Font.PLAIN, 21));
