		...
		btnInicializar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(!inicializarTrabajadores){
					...
					tiendaPC.addTrabajador("Jorge Luis","Valdés Piñeda","97070758088", counterTrabajador++,15000,"Universitario","Subgerente");
					tiendaPC.addTrabajador("Javier","Soto Villanueva","05090160882", counterTrabajador++,7000,"Universitario","Asesor de Ventas");
					tiendaPC.addTrabajador("Ronal","Sálazar Hernández","05101568066", counterTrabajador++,6500,"Universitario","Especialista en Software");
					tiendaPC.addTrabajador("Aylin","Vázquez Alvarez","06061367412", counterTrabajador++,4000,"Obrero Calificado","Encargado de inventario");
					...
					JOptionPane.showMessageDialog(null,"Se han añadido 5 datos de trabajadores a la tienda correctamente.","Inicialización Exitosa",JOptionPane.INFORMATION_MESSAGE);
					numIDT.setText(Integer.toString(counterTrabajador));
