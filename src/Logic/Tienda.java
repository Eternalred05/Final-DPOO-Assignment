...
public class Tienda {
	...
	public void addRAM(int cantidadDisponible, String numeroSerie, String marca, double memoria , String tipo, double precioBase) {
		...
		for(Componente c : componentes){
			if(c instanceof RAM){
				if(c.getNumeroSerie().equals(ram.numeroSerie))
	...
	public ArrayList<Trabajador> trabajadoresPorSalarioCargoEscolaridad(double salario, String cargo, String escolaridad){
		ArrayList<Trabajador> listado = new ArrayList<>();
		for(Trabajador t : trabajadores)
			if(t.getSalario()== salario && t.getCargo().equals(cargo) && t.getNivelEscolar().equals(escolaridad))
				listado.add(t);
		return listado;
	}

	public ArrayList<PC> pcPorPrecio(double precio){
	...
	public ArrayList<Componente> componentesPorMarcaPrecio(String marca, double precio){
	...
	public ArrayList<Componente> ramsPorVelocidadMemoria(String tipo, double memoria){
		ArrayList<Componente> listado = new ArrayList<>();
		for(Componente c : componentes)
			if(c instanceof RAM)
